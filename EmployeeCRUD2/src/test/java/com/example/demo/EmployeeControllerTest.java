...
public class EmployeeControllerTest {
	...
	@Test
	public void givenEmployeeId_wwhenGetEmployeebyId_ThenReturnNotOk() throws Exception {
		Employee employee = new Employee(1, "sai1", 55000, "sai1.shinde@yash.com");

		Mockito.when(employeeService.getEmployeeById(1)).thenReturn(Optional.ofNullable(null));
...
//		  verify(employeeService,times(1)).deleteEmployeeById(id);
	...
	@Test
	public void shouldNotDeleteEmployeeIfEmployeeDoesNotExists() throws Exception {
		Integer id = 2;
...
//		  verify(employeeService,times(1)).deleteEmployeeById(id);
	...
	@Test
	public void givenInvalidEmployeeId_whenUpdateEmployeebyId_ThenReturn404() throws Exception {
		Employee employee = new Employee(2, "sai2", 65000, "sai2.shinde@yash.com");
