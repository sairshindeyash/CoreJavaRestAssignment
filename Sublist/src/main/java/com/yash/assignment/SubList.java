...
public class SubList {
	...
	public List<Integer> sublist(int startIndex, int endIndex, List<Integer> asList) {
		...
		if(startIndex>endIndex)
			throw new IllegalArgumentException("Start Index can not exceed end index");
		if(endIndex>asList.size())
			throw new ArrayIndexOutOfBoundsException("End index can not exceed list size");
